...
function Porsche(props) {
  // @ts-ignore
  const { scene, nodes, materials } = useGLTF("/assets/glb/911-transformed.glb")
  useLayoutEffect(() => {
    Object.values(nodes).forEach((node) => {
      // @ts-ignore
      return node.isMesh && (node.receiveShadow = node.castShadow = true)
    })
